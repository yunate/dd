...
/////////////////////ddtask_queue/////////////////////
ddtask_queue::ddtask_queue(u32 max_count /* = MAX_S32 */, const std::function<void()>& on_any_task_complete /* = nullptr */) :
...
void ddtask_queue::set_any_task_complete_handler(const std::function<void()>& on_any_task_complete)
{
    std::lock_guard<std::mutex> lock(m_mutex);
