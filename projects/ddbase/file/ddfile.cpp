...
ddfile* ddfile::create_or_open(const std::wstring& path)
{
...
ddfile* ddfile::create_file_with_head_checker(const std::wstring& path, const u8* head_checker, s32 head_checker_size)
{
...
ddfile* ddfile::create_usc2_file(const std::wstring& path)
{
    return create_file_with_head_checker(path, usc2_le_header, sizeof(usc2_le_header));
}

ddfile* ddfile::create_usc2_file_be(const std::wstring& path)
{
    return create_file_with_head_checker(path, usc2_be_header, sizeof(usc2_be_header));
}

ddfile* ddfile::create_utf8_file(const std::wstring& path)
{
    return create_file_with_head_checker(path, nullptr, 0);
}

ddfile* ddfile::create_utf8bom_file(const std::wstring& path)
{
    return create_file_with_head_checker(path, utf8_bom_header, sizeof(utf8_bom_header));
}
