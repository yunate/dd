...
public:
    ...
    void send_to(void* buff, s32 buff_size, const ddaddr& addr, const std::function<void(bool successful, s32 byte)>& callback, ddexpire expire = ddexpire::never);
    ...
    void recv_from(void* buff, s32 buff_size, ddaddr& addr, const std::function<void(bool successful, s32 byte)>& callback, ddexpire expire = ddexpire::never);
