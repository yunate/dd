...
public:
    ...
    */
    ...
    @param [in] callBack 回调函数，对每一个路径进行处理
                ...
                @return true 停止枚举
    */
    static void enum_dir_first_level(const std::wstring& dir_path, std::function<bool(const std::wstring& name, bool is_dir)> call_back);
    ...
    @param [in] callBack 回调函数，对每一个路径进行处理
                ...
                @return true 停止枚举
    */
    static void enum_dir(const std::wstring& dir_path, std::function<bool(const std::wstring& full_path, bool is_dir)> call_back);
    ...
    @param [in] callBack 回调函数，对每一个路径进行处理
                ...
                @return true 停止枚举
    */
    static void enum_dir(const std::wstring& dir_path, std::function<bool(const std::wstring& sub_path, const std::wstring& name, bool is_dir)> call_back);
    ...
    */
    static void enum_dir(const std::wstring& dir_path, std::vector<std::wstring>& out, std::function<bool(const std::wstring& path, bool is_dir)> filter);
};
