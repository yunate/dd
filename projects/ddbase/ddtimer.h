...
#ifndef ddbase_ddtimer_h_
#define ddbase_ddtimer_h_
...
struct ddtime
{
    ...
    // 获得超时时间戳 now + timeout
    static u64 get_experid_timestamp(u64 timeout);
    // 获得超时长度experid_timestamp - now
    static u64 get_timeout(u64 experid_timestamp);
};
